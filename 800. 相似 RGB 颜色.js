...
function similarRGB(color) {
    ...
    console.log(temp)
    return '#' + temp.map(v => v.toString(16)).map(v => {
        if (v < 10) {
            return ('0' + v)
        } else {
            return v
